...
class BaseX2HAttLayer(nn.Module):
    """Uses spatial relationships to update node features."""
    """This layer is used to update node features (atom types) based on the spatial relationships (atom positions) between nodes.
    It computes attention scores based on the distance between nodes and uses these scores to update the node features."""
