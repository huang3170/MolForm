...
class PrepLig(object):
    ...
    def get_pdbqt(self, lig_pdbqt=None):
        print("Calling get_pdbqt for PrepLig")
        ...
        print("Completed get_pdbqt for PrepLig")
        

class PrepProt(object): 
    def __init__(self, pdb_file): 
        self.prot = pdb_file
        print("Initialized PrepProt")
    ...
    def addH(self, prot_pqr):  # call pdb2pqr
        print("Calling addH for PrepProt")
        ...
        print("Completed addH for PrepProt")

    # def get_pdbqt(self, prot_pdbqt):
    #     print("Calling get_pdbqt for PrepProt")
    #     prepare_receptor = "/home/dhzhang/targetdiff/AutoDockTools_py3/AutoDockTools/Utilities24/prepare_receptor4.py"
    #     subprocess.Popen(['python3', prepare_receptor, '-r', self.prot_pqr, '-o', prot_pdbqt],
    #                     stderr=subprocess.DEVNULL, stdout=subprocess.DEVNULL).communicate()
    #     print("Completed get_pdbqt for PrepProt")
    def get_pdbqt(self, prot_pdbqt):
...
class VinaDock(object): 
    def __init__(self, lig_pdbqt, prot_pdbqt): 
        print('prot_pdbqt',prot_pdbqt)
        self.lig_pdbqt = lig_pdbqt
        self.prot_pdbqt = prot_pdbqt
        print("Initialized VinaDock")
    ...
    def dock(self, score_func='vina', seed=0, mode='dock', exhaustiveness=8, save_pose=False, **kwargs):  # seed=0 mean random seed
        try:
            print("Starting Vina initialization...")
            ...
            print(v.compute_vina_maps(center=self.pocket_center, box_size=self.box_size))
            if mode == 'score_only':
                print("Scoring...") 
                score = v.score()[0]
            elif mode == 'minimize':
                ...
                raise ValueError
            print("Completed dock for VinaDock")
...
class VinaDockingTask(BaseDockingTask):
    ...
    def run(self, mode='dock', exhaustiveness=8, **kwargs):
        ...
        print("Completed VinaDockingTask")
        print("Completed VinaDockingTask")
